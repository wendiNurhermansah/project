                                                                    ...
                                                                    <td>
                                                                        <select class="select2 form-control r-0 light s-12" name="jenis_pesanan[]" id="jenis_pesanan" onchange="option(this)" autocomplete="off">
                                                                            ...
                                                                            @foreach ($barang as $item)
                                                                                <option value="{{$item->id}}" id="jenisPesanan" {{ $item->id == $i->jenis_pesanan ? 'selected' : '' }}>{{$item->nama_barang}}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </td>
                                                                    <td >
                                                                        <input class="text-center" type="text" name="harga[]" id="harga" autocomplete="off" value="{{$i->harga}}"  readonly/>
                                                                    </td>
                                                                    <td>
                                                                        <input class="text-center" type="text" name="jumlah[]" id="jumlah"  onkeyup="onjumlah()" value="{{$i->jumlah}}" autocomplete="off" />
                                                                    </td>
                                                                    <td>
                                                                        <input class="text-center" type="text" name="total[]" id="total" value="{{$i->total}}" autocomplete="off" readonly/>
                                                                    </td>
                                                                    <td>
                                                                        <input class="text-center" type="text" name="keterangan[]"  id="keterangan" value="{{$i->keterangan}}" autocomplete="off" />    
                                                                    </td>
  ...
  var i = 0;
        ...
        $('#tambah').click(function(){
            ...
            $('#dinamic').append(`<tr id="trTable`+i+`">
                                                                ...
                                                                <td>
                                                                    <input class="text-center" type="text" name="jumlah[]" id="jumlah_`+i+`" onkeyup="onjumlah3(`+i+`)"  autocomplete="off" />
                                                                </td>
                                                                <td>
             ...
             i++;
                ...
                $('#dinamic').append(`
                    <tr id="trTable`+i+`">
                        ...
                        <td>
                            <input class="text-center" type="text" name="total[]" id="total_4`+i+`" value=`+value.total+` autocomplete="off" />
                        </td>
                        <td>
